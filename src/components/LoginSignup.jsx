...
return (
    ...
    id='login' className=' w-[80%] md:w-[480px] z-[10] lg:w-[33%] bg-dimwhite py-8 px-10 items-center left-0 right-0 mx-auto absolute top-[90%] lg:right-[-50%] lg:top-[100%] overflow-hidden'>
