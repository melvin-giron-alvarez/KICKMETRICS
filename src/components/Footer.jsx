        ...
        <div className='flex flex-wrap w-full p-10 justify-between'>
            <div className='w-[95%] md:w-[32%] mb-[2em] md:mb-0'>
                ...
                <div className='block w-full roboto-medium'>
                    ...
                    <form onSubmit={handleSubscribed} className="flex">
                        <input 
                            type='email'
                            ...
                            required />
                        <button className={`w-auto text-grey hover:text-black roboto-medium text-[.6em] ml-2 px-5 py-2 sm:px-10 border-[1px]`} type='submit' >ENTER</button>
                    </form>  
                </div>
            </div>
